...
import { Call, CallCode, Claim as ClaimType, Method } from '../../../../types'
...
export default function Claim({ addCall }: Props) {
	const [selected, setSelected] = useState(false)
	const [advanced, setAdvanced] = useState(false)
	const [call, setCall] = useState<ClaimType>(initialCall)
	...
	return (
		<div className={styles.container} style={{ background: theme.top }}>
			<header className={styles.header}>
				<p style={{ color: theme.primary }}>Claim</p>
