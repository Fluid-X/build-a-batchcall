...
import {
	Call,
	CallCode,
	ApproveSubscription as ApproveSubscriptionType,
	Method
} from '../../../../types'
...
const initialCalls: ApproveSubscriptionType = {
...
export default function ApproveSubscription({ addCall }: Props) {
	const [selected, setSelected] = useState(false)
	const [advanced, setAdvanced] = useState(false)
	const [call, setCall] = useState<ApproveSubscriptionType>(initialCalls)
	...
	return (
		<div className={styles.container} style={{ background: theme.top }}>
			<header className={styles.header}>
				<p style={{ color: theme.primary }}>Approve Subscription</p>
