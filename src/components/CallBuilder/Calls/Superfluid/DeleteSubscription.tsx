...
import {
	Call,
	CallCode,
	DeleteSubscription as DeleteSubscriptionType,
	Method
} from '../../../../types'
...
const initialCall: DeleteSubscriptionType = {
...
export default function DeleteSubscription({ addCall }: Props) {
	const [selected, setSelected] = useState(false)
	const [advanced, setAdvanced] = useState(false)
	const [call, setCall] = useState<DeleteSubscriptionType>(initialCall)
	...
	const handleSubmit = (event: FormEvent<HTMLInputElement>) => {
		...
		if (!isValidAddress(call.subscriber)) {
	...
	return (
		<div className={styles.container} style={{ background: theme.top }}>
			<header className={styles.header}>
				<p style={{ color: theme.primary }}>Delete Subscription</p>
